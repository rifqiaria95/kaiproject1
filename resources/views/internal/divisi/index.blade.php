...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        ...
        <table id="Tabledivisi" class="datatables-users table">
        ...
        tabindex="-1"
        id="offcanvasAdddivisi"
        aria-labelledby="offcanvasAddUserLabel">
            <div class="offcanvas-header border-bottom">
                <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Tambah Divisi</h5>
                <button
                type="button"
            ...
            <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
                <form id="formdivisi" name="formdivisi" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <div id="nama_divisi-error" class="text-danger small"></div>
                    </div>
                    <div class="mb-6">
...
<script src="{{ url('assets/ajax/divisi.js') }}"></script>
