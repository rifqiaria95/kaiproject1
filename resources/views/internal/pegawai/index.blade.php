                                            ...
                                            <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-6 mb-6">
                                                        ...
                                                        <input type="date" class="form-control" id="tgl_lahir_pegawai"
                                                            placeholder="John Doe" name="tgl_lahir_pegawai"
                                                            aria-label="John Doe" />
                                                    </div>
                                                    <div class="col-xl-6 mb-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6 mb-6">
                                                        ...
                                                        <input type="tel" id="no_telp_pegawai" class="form-control"
                                                            placeholder="+62" aria-label="john.doe@example.com"
                                                            name="no_telp_pegawai"
                                                            oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
                                                    </div>
                                                    <div class="col-xl-6 mb-6">
                                                        <label class="form-label" for="add-pegawai-company">KTP</label>
                                                        <input type="number" id="no_ktp_pegawai" class="form-control"
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6 mb-6">
                                                        ...
                                                        <input type="number" id="no_sim_pegawai" class="form-control"
                                                            placeholder="3275031XXXXX" aria-label="jdoe1"
                                                            name="no_sim_pegawai"
                                                            oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
                                                    </div>
                                                    <div class="col-xl-6 mb-6">
                                                        ...
                                                        <input type="number" id="no_npwp_pegawai" class="form-control"
                                                            placeholder="3275031XXXXX" aria-label="jdoe1"
                                            ...
                                            <div class="tab-pane fade" id="navs-top-profile" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-xl-12 mb-6">
                                                        ...
                                                        <textarea class="form-control" id="alamat_pegawai"
                                                            name="alamat_pegawai" rows="3"></textarea>
                                                    </div>
                                                    <div class="col-xl-6 mb-6">
                                                        <label class="form-label"
                                                        ...
                                                        <select id="pegawai-provinsi" class="select2 form-select"
                                                            ...
                                                            <option value="{{ $prv->id_provinsi }}">{{ $prv->name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade" id="navs-top-messages" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-xl-6 mb-6">
                                                        <label class="form-label" for="add-pegawai-fullname">Tanggal
                                                            Masuk</label>
                                                        <input type="date" class="form-control" id="tgl_masuk_pegawai"
                                                            placeholder="John Doe" name="tgl_masuk_pegawai"
                                                            aria-label="John Doe" />
                                                    </div>
                                                    <div class="col-xl-6 mb-6">
                                                        <label class="form-label" for="add-pegawai-fullname">Tanggal
                                                            Keluar</label>
                                                        <input type="date" class="form-control" id="tgl_keluar_pegawai"
                                                            placeholder="John Doe" name="tgl_keluar_pegawai"
                                                            aria-label="John Doe" />
                                                    </div>
                                                    <div class="col-xl-6 mb-6">
                                                        <label class="form-label"
                                                        ...
                                                        <select id="pegawai-perusahaan" class="select2 form-select"
                                                            ...
                                                            <option value="{{ $per->id }}">{{ $per->nama_perusahaan }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-6 mb-6">
                                                        ...
                                                        <select id="pegawai-divisi" class="select2 form-select"
                                                            ...
                                                            <option value="{{ $div->id }}">{{ $div->nama_divisi }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-6 mb-6">
                                                        <label class="form-label" for="pegawai-jabatan">Jabatan</label>
                                                        <select id="pegawai-jabatan" class="select2 form-select"
                                                            name="id_jabatan">
                                                            <option selected disabled>Pilih Jabatan</option>
                                                            @foreach ($jabatan as $jab)
                                                            <option value="{{ $jab->id }}">{{ $jab->nama_jabatan }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
