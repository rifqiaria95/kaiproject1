    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive">
                <table id="TablekategoriGaleri" class="datatables-users table">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddkategoriGaleri"
                aria-labelledby="offcanvasAddUserLabel">
                <div class="offcanvas-header border-bottom">
                    <h5 id="offcanvasAddkategoriGaleriLabel" class="offcanvas-title">Tambah Kategori Galeri</h5>
                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                        aria-label="Close"></button>
                </div>
                <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
                    <form id="formkategoriGaleri" name="formkategoriGaleri" enctype="multipart/form-data">
                        @csrf
