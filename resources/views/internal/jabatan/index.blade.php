...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        ...
        <table id="Tablejabatan" class="datatables-users table">
        ...
        tabindex="-1"
        id="offcanvasAddjabatan"
        aria-labelledby="offcanvasAddUserLabel">
            <div class="offcanvas-header border-bottom">
                <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Tambah Jabatan</h5>
                <button
                type="button"
            ...
            <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
                <form id="formjabatan" name="formjabatan" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <div id="nama_jabatan-error" class="text-danger small"></div>
                    </div>
                    <div class="mb-6">
...
<script src="{{ url('assets/ajax/jabatan.js') }}"></script>
