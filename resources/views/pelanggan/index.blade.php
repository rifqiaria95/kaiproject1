                ...
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="modal-judul">Tambah pelanggan</h4>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="pelanggan-kendaraan">Kendaraan</label>
                                                            <select id="pelanggan-kendaraan" class="select2 form-select" name="id_kendaraan">
                                                                <option selected disabled>Pilih Kendaraan</option>
                                                                @foreach ($kendaraan as $kndr)
                                                                    <option value="{{ $kndr->id }}">{{ $kndr->merk_kendaraan }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pelanggan-company">Plat Nomor</label>
                                                            <input
                                                                type="text"
                                                                id="plat_nomor"
                                                                class="form-control"
                                                                placeholder="B3432KGP"
                                                                aria-label="jdoe1"
                                                                name="plat_nomor"
                                                            />
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pelanggan-company">Deskripsi</label>
                                                            <input
                                                                type="text"
                                                                id="deskripsi"
                                                                class="form-control"
...
<script src="{{ asset('assets/ajax/pelanggan.js') }}"></script>
@endsection
