...
$(document).ready(function () {
            ...
            },
            {
                ...
                render: function (data, type, full, meta) {
                    return (
                        ...
                        '<a href="javascript:;" class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill delete-record" data-id="' + full.id_pegawai + '"><i class="ti ti-trash ti-md"></i></a>' +
                        ...
                        '<a href="javascript:;" class="dropdown-item" onclick="ViewData(' + full.id_pegawai + ')">Edit</a>' +
                        '</div>' +
                        '</div>'
                    );
                }
    ...
    $(document).ready(function(){
        $('#formPegawai').on('submit', function(e){
            ...
            if(id_pegawai == "" || id_pegawai == 0){
                url = "/pegawai/store";
            } else {
                url = "/pegawai/update/" + id_pegawai;
