        ...
        columns: [{
            ...
            },
            {
                ...
                render: function (data, type, full, meta) {
                    ...
                    let canEdit         = userPermissions.includes("edit perusahaan");
                    let canDelete       = userPermissions.includes("delete perusahaan");
                    ...
                    if (canEdit) {
                        ...
                        buttons += '<a href="javascript:;" class="dropdown-item" onclick="editPerusahaan(\'' + full.id + '\')">Edit</a>';
                        buttons += '</div>';
                    }
