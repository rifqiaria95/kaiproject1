                                        ...
                                        <div class="nav-align-top nav-tabs mb-6">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                                                    <div class="row">
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pegawai-fullname">Nama Pegawai</label>
                                                            <input
                                                                type="text"
                                                                class="form-control"
                                                                id="nm_pegawai"
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <fieldset class="form-group">
                                                                ...
                                                                <select class="select form-select" name="jenis_kelamin" id="jenis_kelamin" required>
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pegawai-fullname">Tanggal Lahir</label>
                                                            <input
                                                                type="date"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pegawai-email">Email</label>
                                                            <input
                                                                type="email"
                                                                id="email"
                                                                class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pegawai-email">No Tlp</label>
                                                            <input
                                                                type="tel"
                                                                id="no_telp_pegawai"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pegawai-company">KTP</label>
                                                            <input
                                                                type="number"
                                                                id="no_ktp_pegawai"
                                                                class="form-control"
                                                                placeholder="3275031XXXXX"
                                                                aria-label="jdoe1"
                                                                name="no_ktp_pegawai"
                                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pegawai-company">SIM</label>
                                                            <input
                                                                type="number"
                                                                id="no_sim_pegawai"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pegawai-company">NPWP</label>
                                                            <input
                                                                type="number"
                                                                id="no_npwp_pegawai"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-xl-12 mb-6">
                                                            <fieldset class="form-group">
                                                                ...
                                                                <select class="select form-select" name="active" id="active" required>
                                                ...
                                                <div class="tab-pane fade" id="navs-top-profile" role="tabpanel">
                                                    <div class="row">
                                                        <div class="col-xl-12 mb-6">
                                                            <label class="form-label" for="add-pegawai-company">Alamat</label>
                                                            <textarea class="form-control" id="alamat_pegawai" name="alamat_pegawai" rows="3"></textarea>
                                                        </div>
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="pegawai-provinsi">Provinsi</label>
                                                            <select id="pegawai-provinsi" class="select2 form-select" name="id_provinsi">
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            ...
                                                            <select id="pegawai-kota" class="select2 form-select form-select-md" name="id_kota">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 mb-6">
                                                            ...
                                                            <input
                                                                type="date"
                                                                class="form-control"
                                                                id="tgl_masuk_pegawai"
                                                                placeholder="John Doe"
                                                                name="tgl_masuk_pegawai"
                                                                aria-label="John Doe" />
                                                        </div>
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pegawai-fullname">Tanggal Keluar</label>
                                                            <input
                                                                type="date"
                                                                class="form-control"
                                                                id="tgl_keluar_pegawai"
                                                                placeholder="John Doe"
                                                                name="tgl_keluar_pegawai"
                                                                aria-label="John Doe" />
                                                        </div>
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pegawai-email">Jabatan</label>
                                                            <input
                                                                type="text"
                                                                id="jabatan_pegawai"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pegawai-company">Gaji Pegawai</label>
                                                            <input
                                                                type="number"
                                                                id="gaji_pegawai"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-xl-12 mb-6">
                                                            ...
                                                            <input type="file" id="foto_pegawai" name="foto_pegawai" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
