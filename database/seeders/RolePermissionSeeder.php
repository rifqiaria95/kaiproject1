...
class RolePermissionSeeder extends Seeder
{
    ...
    {
        $permissions = [
            ['name' => "view item", 'menu_group_id' => 1, 'menu_detail_id' => 3],
            ['name' => "create item", 'menu_group_id' => 1, 'menu_detail_id' => 3],
            ['name' => "edit item", 'menu_group_id' => 1, 'menu_detail_id' => 3],
            ['name' => "delete item", 'menu_group_id' => 1, 'menu_detail_id' => 3],
            ...
            ['name' => "view menu detail", 'menu_group_id' => 5, 'menu_detail_id' => 5],
            ['name' => "create menu detail", 'menu_group_id' => 5, 'menu_detail_id' => 5],
            ['name' => "edit menu detail", 'menu_group_id' => 5, 'menu_detail_id' => 5],
            ['name' => "delete menu detail", 'menu_group_id' => 5, 'menu_detail_id' => 5],
        ];
