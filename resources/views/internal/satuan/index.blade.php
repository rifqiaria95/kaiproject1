...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        ...
        <table id="TableSatuan" class="datatables-users table">
        ...
        tabindex="-1"
        id="offcanvasAddSatuan"
        aria-labelledby="offcanvasAddUserLabel">
            <div class="offcanvas-header border-bottom">
                <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Add Satuan</h5>
                <button
                type="button"
            ...
            <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
                <form id="formSatuan" name="formSatuan" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-6">
                        <label class="form-label" for="simbol">Simbol</label>
                        <input type="text" id="simbol" class="form-control" name="simbol" placeholder="Route Satuan">
                    </div>
