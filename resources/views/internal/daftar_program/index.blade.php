                                                ...
                                                <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                                                    <div class="row">
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pelanggan-fullname">Nama Program</label>
                                                            <input
                                                                type="text"
                                                                class="form-control"
                                                                id="name"
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="jenis_program">Jenis Program</label>
                                                            <select id="jenis_program" class="select2 form-select" name="jenis_program_id">
                                                                <option selected disabled>Pilih Jenis Program</option>
                                                                @foreach ($jenis_program as $jns)
                                                                    <option value="{{ $jns->id }}">{{ $jns->nama_jenis_program }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pelanggan-company">Tanggal Mulai</label>
                                                            <input
                                                                type="date"
                                                                id="start_date"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pelanggan-company">Tanggal Berakhir</label>
                                                            <input
                                                                type="date"
                                                                id="end_date"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pelanggan-company">Kuota</label>
                                                            <input
                                                                type="number"
                                                                id="kuota"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pelanggan-company">Kategori</label>
                                                            <input
                                                                type="text"
                                                                id="kategori"
                                                                class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="add-pelanggan-company">Sumber Dana</label>
                                                            <input
                                                                type="text"
                                                                id="sumber_dana"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-xl-12 mb-6">
                                                            <label class="form-label" for="add-program-description">Deskripsi</label>
                                                            <textarea
                                                                type="text"
                                                                id="description"
                                                                class="form-control"
