    ...
    columns: [{
        ...
        },
        {
            ...
            render: function (data, type, full, meta) {
                ...
                let canEdit         = userPermissions.includes("edit_vendor");
                let canDelete       = userPermissions.includes("delete_vendor");
                ...
                buttons += '<a href="javascript:;" class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical ti-md"></i></a>';
                    ...
                    if (canEdit) {
                      buttons += '<a href="javascript:;" class="dropdown-item" onclick="editVendor(' + full.id + ')"><i class="ti ti-edit ti-md"></i>Edit</a>';
                    }
                    if (canDelete) {
